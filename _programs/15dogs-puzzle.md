...
privacy_policy_link: "/my_programms/15dogs-puzzle/privacy-policy"
terms_conditions_link: "/my_programms/15dogs-puzzle/terms-conditions"
---

## Описание игры

15:Dogs Puzzle - это классическая игра-пазл, так же известная как игра в пятнашки, блочный пазл, 15 или магический пазл квадрат.

Игра содержит коллекцию высококачественных фотографий собак и подходит как для детей, так и для взрослых.

Вы должны перемещать кусочки изображения, чтобы собрать фотографию одной из собак. Просто нажмите на блок, который вы хотите переместить на свободное поле.
