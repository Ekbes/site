...
TcpLoger - простая программа, позволяющая быстро запустить TCP сервер на выбранном порту или создать клиента и подключиться к серверу.
